...
struct ContentView: View {
    ...
    var tabView: some View {
        ...
        let tabBarView = SwiftUITabBarController(tabItems: [vc1, vc2], configuration: .constant(SSTabConfiguration()), isTabBarHidden: self.$isTabBarHidden)
        return tabBarView
    }
}
